...
echo -e "${red}=========================================${nc}"
echo -e ""
echo -e " ${white}1${nc}. Create SSH & OpenVPN Account"
echo -e " ${white}2${nc}. Trial SSH & OpenVPN Account"
echo -e " ${white}3${nc}. Renew SSH & OpenVPN Account"
echo -e " ${white}4${nc}. Delete SSH & OpenVPN Account"
echo -e " ${white}5${nc}. Check User Login SSH"
echo -e " ${white}6${nc}. List Member SSH & OpenVPN"
echo -e " ${white}7${nc}. Delete Expired SSH & OpenVPN"
