...
wget -q -O /usr/share/nginx/html/openvpn/index.html "https://raw.githubusercontent.com/givps/sshxray/master/openvpn/index"
...
mkdir -p /etc/openvpn/
cd /etc/openvpn/
wget https://raw.githubusercontent.com/givps/sshxray/master/openvpn/server.zip
unzip server.zip
rm -f server.zip
cd
